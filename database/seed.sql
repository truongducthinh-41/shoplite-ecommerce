...
(8, 1, 'Samsung Galaxy S24 Ultra (256GB)', 'Titanium exterior, 200MP camera, and the new Snapdragon 8 Gen 3 for Galaxy. Includes S Pen.', 1299.00, 100, 'https://images.unsplash.com/photo-1678911820864-e6c5bb5d2cf5?auto=format&fit=crop&q=80&w=800&h=800'),
(9, 1, 'Samsung 45W Super Fast Wall Charger', 'Quickly power up your Galaxy S24 Ultra to 100% with the official 45W charger.', 39.99, 250, 'https://images.unsplash.com/photo-1615526675159-e248c3021d3f?auto=format&fit=crop&q=80&w=800&h=800'),
...
(14, 5, 'Dyson V15 Detect Cordless Vacuum', 'Laser reveals microscopic dust. The most powerful, intelligent cordless vacuum.', 749.99, 30, 'https://images.unsplash.com/photo-1527515637462-cff94eecc1ac?auto=format&fit=crop&q=80&w=800&h=800'),
